...
#include "omni_pid_pursuit_controller/pid.hpp"
...
/**
 * @class omni_pid_pursuit_controller::OmniPidPursuitController
...
private:
  ...
  rclcpp_lifecycle::LifecyclePublisher<visualization_msgs::msg::Marker>::SharedPtr velocity_arrow_pub_;
